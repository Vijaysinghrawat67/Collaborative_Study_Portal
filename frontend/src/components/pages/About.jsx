...
import vijay_photo from '../../assets/vijay_photo.jpg';
import askash_photo from '../../assets/aakash_photo.jpg';
import vishal_photo from '../../assets/vishal_photo.jpg'
        ...
        <div className="mt-12">
          ...
          <div className="mt-6 flex flex-wrap justify-center gap-8">
            <div className="text-center">
              ...
              />
              <h4 className="mt-4 text-lg font-semibold text-gray-700">Aakash Bisht</h4>
            ...
            <div className="text-center">
              <img
                ...
                className="w-32 h-32 rounded-full mx-auto shadow-md"
              />
              <h4 className="mt-4 text-lg font-semibold text-gray-700">Vijay Singh Rawat</h4>
            ...
            <div className="text-center">
              <img
                ...
                className="w-32 h-32 rounded-full mx-auto shadow-md"
              />
              <h4 className="mt-4 text-lg font-semibold text-gray-700">Vishal Karki</h4>
